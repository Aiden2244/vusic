...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF8570FF);
  late Color secondary = const Color(0xFFA494FF);
  late Color tertiary = const Color(0xFFC2B8FF);
  late Color alternate = const Color(0xFF6542DC);
  late Color primaryText = const Color(0xFFF0EFFB);
  late Color secondaryText = const Color(0xFFD0CBF6);
  late Color primaryBackground = const Color(0xFF181A1C);
  late Color secondaryBackground = const Color(0xFF292B33);
  late Color accent1 = const Color(0x4D8570FF);
  late Color accent2 = const Color(0x4DA494FF);
  late Color accent3 = const Color(0x4CC2B8FF);
  late Color accent4 = const Color(0x4D6542DC);
  late Color success = const Color(0xFF249689);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFFF5963);
  late Color info = const Color(0xFFF0EFFB);
