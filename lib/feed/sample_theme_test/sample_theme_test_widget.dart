...
import 'sample_theme_test_model.dart';
export 'sample_theme_test_model.dart';

class SampleThemeTestWidget extends StatefulWidget {
  const SampleThemeTestWidget({Key? key}) : super(key: key);

  @override
  _SampleThemeTestWidgetState createState() => _SampleThemeTestWidgetState();
}

class _SampleThemeTestWidgetState extends State<SampleThemeTestWidget>
    with TickerProviderStateMixin {
  late SampleThemeTestModel _model;
